...
ADMIN_IDS = [6422904023, 987654321]
SUPPORT_CHAT_ID = -4765445638
...
async def broadcast_command(update: Update, context: CallbackContext) -> None:
    ...
    # Рассылка всем пользователям, которые писали боту
    sent_count = 0
...
def main() -> None:
    ...
    application.add_handler(MessageHandler(filters.PHOTO | filters.Document.ALL | filters.VIDEO, handle_user_message))
